...
<div class="d-flex flex-column gap-5">
    ...
    <div class="row d-flex justify-content-center align-items-center mt-3">
        <div class="col-6">
            <img src="<?php echo e(asset('uploads/home/hero.png')); ?>" width="800" height="800" class="object-fit-cover img-fluid" alt="Patissier" />
        </div>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/baptiste/Desktop/jawaad/resources/views/home.blade.php ENDPATH**/ ?>