...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/dashboard_switch_button.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/rating_stars.css')); ?>">
...
<body>
            ...
            <div class="d-flex align-items-center justify-content-around">
                <div class="dropdown">
                    <a class="text-dark text-decoration-none dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-offset="10,25" aria-expanded="false">
                        <img src="<?php echo e(asset(session()->get('user')['avatar'])); ?>" width="30" height="30" class="object-fit-cover rounded-circle">
                    </a>

                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a href="<?php echo e(route('dashboard.show', ['userId' => session()->get('user')['id']])); ?>" class="dropdown-item active-effect-disabled">Profil</a></li>
                        <li>
    ...
    <!-- js for recipe form -->
    <script src="<?php echo e(asset('js/recipe_form.js')); ?>"></script>

</body>

</html><?php /**PATH /Users/baptiste/Desktop/jawaad/resources/views/base.blade.php ENDPATH**/ ?>