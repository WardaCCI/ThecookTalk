...
<body>
    <div class="container">
        <div class="d-flex flex-column m-4 gap-3">
            ...
            <div>
                <a href="<?php echo e(route('firstAuth.show', ['userId' => $emailValidationUserId])); ?>" role="bouton" class="btn btn-primary">
                    Verifier email
                </a>
            </div>
...
</html><?php /**PATH /Users/baptiste/Desktop/jawaad/resources/views/mails/email_validation_content.blade.php ENDPATH**/ ?>